...
export class SidebarComponent {
  ...
  private menuItems: MenuItem[] = [
    ...
    {path: "/accounts", label: "Accounts", icon: "account_balance", roles: [UserRole.USER, UserRole.ADMIN]},
    {path: "/cart", label: "Cart", icon: "shopping_cart", roles: [UserRole.USER, UserRole.ADMIN]},
